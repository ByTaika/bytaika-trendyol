...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    update_option('krn_trendyol_supplier_id', sanitize_text_field($_POST['supplier_id']));
...
$supplierID  = get_option('krn_trendyol_supplier_id');
?>
...
<div class="wrap">
    ...
    <form method="post">
        <table class="form-table">
            ...
            <tr>
                <th>Supplier ID</th>
                <td><input type="text" name="supplier_id" value="<?= $supplierID ?>" class="regular-text"></td>
            </tr>
